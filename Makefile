srcdir = /root/php-5.6.31/ext/sec_ext
builddir = /root/php-5.6.31/ext/sec_ext
top_srcdir = /root/php-5.6.31/ext/sec_ext
top_builddir = /root/php-5.6.31/ext/sec_ext
...
RE2C = exit 0;
AWK = gawk
shared_objects_sec = sec.lo
PHP_PECL_EXTENSION = sec
SEC_SHARED_LIBADD =
PHP_MODULES = $(phplibdir)/sec.la
PHP_ZEND_EX =
...
prefix = /usr/local/php
phplibdir = /root/php-5.6.31/ext/sec_ext/modules
